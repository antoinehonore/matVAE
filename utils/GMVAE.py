...
class InferenceNet(nn.Module):
  def __init__(self, x_dim, z_dim, y_dim,h_dim=512):
...
class GMVAENet(nn.Module):
  def __init__(self, x_dim, z_dim, y_dim, h_dim=512):
    ...
    self.inference = InferenceNet(x_dim, z_dim, y_dim, h_dim=h_dim)
    self.generative = GenerativeNet(x_dim, z_dim, y_dim, h_dim=h_dim)
